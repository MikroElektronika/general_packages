-- Boards listing with optional filters applied before an MCU is selected, gated to supported (released) boards.
...
-- %11 = supported-boards filter active (1 = apply, 0 = skip)
-- %12 = supported board name IN clause values, SQL-quoted comma-separated ('') when inactive)
SELECT
    Boards.*,
