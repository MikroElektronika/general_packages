-- Boards compatible with the selected MCU, with additional filter parameters, gated to supported (released) boards.
-- Parameters:
...
--   %13 = supported-boards filter active (1 = apply, 0 = skip)
--   %14 = supported board name IN clause values, SQL-quoted comma-separated ('') when inactive)
...
-- Supported-boards filter: %13=0 skips; %14 always has at least '' to keep IN() syntactically valid.
